...
ActiveRecord::Schema.define(version: 20200612062002) do
  ...
  create_table "tweet_hashtags", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["hashtag_id"], name: "index_tweet_hashtags_on_hashtag_id", using: :btree
    t.index ["tweet_id"], name: "index_tweet_hashtags_on_tweet_id", using: :btree
  end
